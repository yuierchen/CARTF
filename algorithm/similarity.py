...
def get_topk_questions(query_words,query_matrix,query_idf_vector,questions,topk,similar_threshold):
    relevant_questions = list()
    for question in questions:
        # if query_words==question.method_annotation_words:
        #     continue

        sim = sim_doc_pair(query_matrix, question.title_matrix, query_idf_vector,
                                                         question.title_idf_vector)
        relevant_questions.append((question, question.title_words, sim))
