...
def main():
    ...
    csvfile_path = os.path.join(args.output_path, "topclass.csv")#输出结果
    ...
    for experiment in experiments:
        ...
        #获取相似的TOP-N问题
        top_questions = similarity.get_topk_questions(full_query_matrix, full_query_idf_vector, records, 10, 0.0)
        #获取得到问题的长度
        print(top_questions)
